...
def args_parser():
    ...
    parser.add_argument('--load_state', type=str, default="/content/drive/MyDrive/CS 598 DFLH - Final Project - Medfuse/03medfuse/checkpoints/phenotyping/medFuse/best_checkpoint.pth.tar", help='state dir path')
    parser.add_argument('--load_state_cxr', type=str, default="/content/drive/MyDrive/CS 598 DFLH - Final Project - Medfuse/03medfuse/checkpoints/cxr_rad_full/best_checkpoint.pth.tar", help='state dir path')
    parser.add_argument('--load_state_ehr', type=str, default="/content/drive/MyDrive/CS 598 DFLH - Final Project - Medfuse/03medfuse/checkpoints/phenotyping/uni_ehr_full/best_checkpoint.pth.tar", help='state dir path')
    ...
    parser.add_argument('--ehr_data_dir', type=str, help='Path to the data of phenotyping fusion_type',
                        default="/content/mimic4data/data")
    parser.add_argument('--cxr_data_dir', type=str, help='Path to the data of phenotyping fusion_type',
                        default="/content/cxrdata/physionet.org/files/mimic-cxr-jpg/2.0.0")
